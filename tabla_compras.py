...
sql_crear_compras_tabla= """CREATE TABLE IF NOT EXISTS compras(
...
crear_tabla(conexion, sql_crear_compras_tabla)


#esta es la creación de tabla para listado (de compras)